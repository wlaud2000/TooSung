...
@Table(name = "real_estate_news_analysis")
public class RealEstateNewsAnalysis extends BaseEntity {
    ...
    @JoinColumn(name = "real_estate_news_id", nullable = false, unique = true)
    private RealEstateNews realEstateNews;
