...
public enum AuthErrorCode implements BaseErrorCode {
    ...
    // Token 관련 에러
    REFRESH_TOKEN_NOT_FOUND(HttpStatus.UNAUTHORIZED, "AUTH-003", "Refresh Token이 존재하지 않습니다."),
    INVALID_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH-004", "유효하지 않은 Refresh Token입니다."),
    TOKEN_REUSE_DETECTED(HttpStatus.UNAUTHORIZED, "AUTH-005", "토큰 재사용이 감지되었습니다. 다시 로그인해주세요."),
